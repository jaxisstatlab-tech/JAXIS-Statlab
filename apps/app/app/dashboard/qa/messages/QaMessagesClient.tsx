...
export function QaMessagesClient({
  initialThreads,
  initialSelectedProjectId = null,
  initialThreadData = null,
}: QaMessagesClientProps) {
            ...
            <Card className="h-full min-h-0 p-12 bg-[#01142B] border-white/10 flex flex-col items-center justify-center text-center gap-3">
              ...
              <div className="max-w-md">
                ...
                <p className="text-xs text-white/50 mt-1 leading-relaxed">
                  When administration assigns research studies for QA review, your communication threads will appear here automatically.
                </p>
              </div>
            </Card>
          ) : selectedThread ? (
