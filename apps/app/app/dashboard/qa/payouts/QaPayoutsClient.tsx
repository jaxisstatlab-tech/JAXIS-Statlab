...
export function QaPayoutsClient({ initialData }: QaPayoutsClientProps) {
  ...
  const [sortBy, setSortBy] = useState<QaPayoutSortField>("newest");
        ...
        <div className="border-b border-white/10 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 self-start sm:self-auto flex-wrap">
            <div className="flex items-center gap-2 bg-white/[0.04] border border-white/10 rounded-[2px] px-3 py-1.5 focus-within:border-white/20 transition-colors">
              ...
              <label htmlFor="qa-payout-sort" className="text-[11px] font-mono text-white/50 uppercase tracking-wider select-none shrink-0">
                Sort:
              </label>
              <select
                id="qa-payout-sort"
              ...
              >
                ...
                <option value="gross-desc">Gross Fee (Highest First)</option>
